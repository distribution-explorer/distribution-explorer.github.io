...
The CDF for nonnegative integer :math:`y` is
...
- `Distributions.jl <https://juliastats.org/Distributions.jl/stable/univariate/#Distributions.Geometric>`_
- `Stan <https://mc-stan.org/docs/functions-reference/negative-binomial-distribution.html>`_ (Negative Binomial, from which Geometric may be generated)
