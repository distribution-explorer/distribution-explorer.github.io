...
.. math::
    ...
    1 - \left(\frac{y_\mathrm{min}}{y}\right)^\alpha & & y \ge y_\mathrm{min} \\
    0 & & y < y_\mathrm{min}
    \end{array}
    \right.
    \end{align}
...
| Package              | Syntax                                      |
+======================+=============================================+
| **NumPy**            | ``y_min * (1 + rng.pareto(alpha))``         |
+----------------------+---------------------------------------------+
...
- `Distributions.jl <https://juliastats.org/Distributions.jl/stable/univariate/#Distributions.Pareto>`_
- `Stan <https://mc-stan.org/docs/functions-reference/pareto-distribution.html>`_
