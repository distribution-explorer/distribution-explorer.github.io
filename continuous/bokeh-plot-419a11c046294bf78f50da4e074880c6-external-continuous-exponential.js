(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("cd2c0a3e-55c5-42ca-bb80-295168d9d029");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'cd2c0a3e-55c5-42ca-bb80-295168d9d029' but no matching script tag was found.")
        }
