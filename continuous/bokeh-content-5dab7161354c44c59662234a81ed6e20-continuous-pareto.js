(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b6b9ce6b-df71-408c-a3cb-0fae156f272c");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b6b9ce6b-df71-408c-a3cb-0fae156f272c' but no matching script tag was found.")
        }
