(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d6118807-3bad-463e-966d-5d0d881eb889");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd6118807-3bad-463e-966d-5d0d881eb889' but no matching script tag was found.")
        }
