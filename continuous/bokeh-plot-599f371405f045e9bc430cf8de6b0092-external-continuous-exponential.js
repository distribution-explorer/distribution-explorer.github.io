(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("4364a8bc-2bf6-47db-bc01-533a3eaebcbd");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '4364a8bc-2bf6-47db-bc01-533a3eaebcbd' but no matching script tag was found.")
        }
