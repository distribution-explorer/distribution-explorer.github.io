(function() {
  const fn = function() {
    ...
    const element = document.getElementById("f18851d3-fcbd-46a8-bf04-703afe472e16");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f18851d3-fcbd-46a8-bf04-703afe472e16' but no matching script tag was found.")
        }
