(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("a4ac3ef6-3d7d-4d46-a37a-81f30385bc39");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a4ac3ef6-3d7d-4d46-a37a-81f30385bc39' but no matching script tag was found.")
        }
