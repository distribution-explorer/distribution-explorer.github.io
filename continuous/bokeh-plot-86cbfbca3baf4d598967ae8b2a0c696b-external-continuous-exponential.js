(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("11ed2b1d-8027-4fdb-ada1-849941eff0de");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '11ed2b1d-8027-4fdb-ada1-849941eff0de' but no matching script tag was found.")
        }
