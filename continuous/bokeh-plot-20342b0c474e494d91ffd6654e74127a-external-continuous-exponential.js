(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("9d159666-d15e-49ab-81bf-0f7f473d8bad");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '9d159666-d15e-49ab-81bf-0f7f473d8bad' but no matching script tag was found.")
        }
