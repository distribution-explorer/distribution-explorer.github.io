(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("4dce638a-7197-4146-9741-8f5ff0207b85");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '4dce638a-7197-4146-9741-8f5ff0207b85' but no matching script tag was found.")
        }
