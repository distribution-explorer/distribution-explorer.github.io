(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b11f7b8e-42f5-4c3e-9526-316edad6e6b7");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b11f7b8e-42f5-4c3e-9526-316edad6e6b7' but no matching script tag was found.")
        }
