(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c84a7880-1c00-43d1-b2c1-9fcc77049d08");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c84a7880-1c00-43d1-b2c1-9fcc77049d08' but no matching script tag was found.")
        }
