(function() {
  const fn = function() {
    ...
    const element = document.getElementById("eac3d6de-6d1a-4825-943b-b115440ad06f");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'eac3d6de-6d1a-4825-943b-b115440ad06f' but no matching script tag was found.")
        }
