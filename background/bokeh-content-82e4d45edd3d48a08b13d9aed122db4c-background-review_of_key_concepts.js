(function() {
  const fn = function() {
    ...
    const element = document.getElementById("ea23da86-fc97-4fc5-9daa-d90348793bba");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ea23da86-fc97-4fc5-9daa-d90348793bba' but no matching script tag was found.")
        }
