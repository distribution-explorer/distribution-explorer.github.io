(function() {
  const fn = function() {
    ...
    const element = document.getElementById("eec6226e-78c7-4af0-b7b2-16c45d50b0d1");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'eec6226e-78c7-4af0-b7b2-16c45d50b0d1' but no matching script tag was found.")
        }
