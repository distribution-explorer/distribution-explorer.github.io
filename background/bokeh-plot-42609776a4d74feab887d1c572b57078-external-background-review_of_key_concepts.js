(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("4480056a-c310-429e-a294-32c3dbbfcc02");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '4480056a-c310-429e-a294-32c3dbbfcc02' but no matching script tag was found.")
        }
