(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c89b33ee-8769-4a70-911b-dd3c3cd3f18c");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c89b33ee-8769-4a70-911b-dd3c3cd3f18c' but no matching script tag was found.")
        }
