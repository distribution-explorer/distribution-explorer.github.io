(function() {
  const fn = function() {
    ...
    const element = document.getElementById("af056a40-651e-486b-9ee1-9c6a595a0be0");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'af056a40-651e-486b-9ee1-9c6a595a0be0' but no matching script tag was found.")
        }
