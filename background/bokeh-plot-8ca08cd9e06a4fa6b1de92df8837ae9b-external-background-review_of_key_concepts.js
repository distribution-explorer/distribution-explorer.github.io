(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("335eb00e-dae3-4115-8728-e6389413329c");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '335eb00e-dae3-4115-8728-e6389413329c' but no matching script tag was found.")
        }
