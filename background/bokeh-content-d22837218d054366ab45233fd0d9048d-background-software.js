(function() {
  const fn = function() {
    ...
    const element = document.getElementById("eec3c950-18e9-4bae-934d-a5d6abfeac55");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'eec3c950-18e9-4bae-934d-a5d6abfeac55' but no matching script tag was found.")
        }
