(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a3566058-bcfe-4384-8830-377ea9e4648e");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a3566058-bcfe-4384-8830-377ea9e4648e' but no matching script tag was found.")
        }
