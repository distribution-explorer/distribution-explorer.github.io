(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a936c84f-6dbc-4ee3-9780-30c8561be297");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a936c84f-6dbc-4ee3-9780-30c8561be297' but no matching script tag was found.")
        }
