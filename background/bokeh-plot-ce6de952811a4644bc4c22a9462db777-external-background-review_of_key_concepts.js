(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("b8cd96be-24df-4314-bcfd-b45bc01b5b89");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b8cd96be-24df-4314-bcfd-b45bc01b5b89' but no matching script tag was found.")
        }
