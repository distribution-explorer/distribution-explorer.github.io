(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b9ffa98e-9cbc-4ab7-bf06-12cd265d044d");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b9ffa98e-9cbc-4ab7-bf06-12cd265d044d' but no matching script tag was found.")
        }
