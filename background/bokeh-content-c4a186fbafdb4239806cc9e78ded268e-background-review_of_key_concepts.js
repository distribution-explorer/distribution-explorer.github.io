(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bfbae542-93dc-482f-83f5-7174625f867e");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bfbae542-93dc-482f-83f5-7174625f867e' but no matching script tag was found.")
        }
