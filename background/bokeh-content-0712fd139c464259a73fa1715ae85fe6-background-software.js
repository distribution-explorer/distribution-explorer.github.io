(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d20f701e-502c-4a84-8632-88f9b99a0186");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd20f701e-502c-4a84-8632-88f9b99a0186' but no matching script tag was found.")
        }
