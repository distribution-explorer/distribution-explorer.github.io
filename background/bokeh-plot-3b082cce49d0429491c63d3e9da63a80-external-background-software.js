(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("23a4e284-0b89-4691-8be4-48a1febe580e");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '23a4e284-0b89-4691-8be4-48a1febe580e' but no matching script tag was found.")
        }
