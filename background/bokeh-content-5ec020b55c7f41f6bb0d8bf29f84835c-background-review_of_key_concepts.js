(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bb1b11aa-1955-4f7a-86c7-422b7617dedd");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bb1b11aa-1955-4f7a-86c7-422b7617dedd' but no matching script tag was found.")
        }
