(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b2097447-30fc-412a-a2a3-ba1122dc197b");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b2097447-30fc-412a-a2a3-ba1122dc197b' but no matching script tag was found.")
        }
