(function() {
  const fn = function() {
    ...
    const element = document.getElementById("ea59d9df-93ca-4f5c-9de5-5acf817e1242");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ea59d9df-93ca-4f5c-9de5-5acf817e1242' but no matching script tag was found.")
        }
