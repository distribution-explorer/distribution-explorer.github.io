(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("0cdc6dda-2c71-41b8-a85c-04e1ca70894e");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '0cdc6dda-2c71-41b8-a85c-04e1ca70894e' but no matching script tag was found.")
        }
