(function() {
  const fn = function() {
    ...
    const element = document.getElementById("db223602-3dd0-48a6-ae9b-7c3086d2bcea");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'db223602-3dd0-48a6-ae9b-7c3086d2bcea' but no matching script tag was found.")
        }
