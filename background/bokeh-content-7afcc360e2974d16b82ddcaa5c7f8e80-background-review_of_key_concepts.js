(function() {
  const fn = function() {
    ...
    const element = document.getElementById("f88226c2-36f0-4e88-9d5f-229c364ddec0");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f88226c2-36f0-4e88-9d5f-229c364ddec0' but no matching script tag was found.")
        }
