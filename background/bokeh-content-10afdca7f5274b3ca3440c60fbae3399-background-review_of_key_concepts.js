(function() {
  const fn = function() {
    ...
    const element = document.getElementById("f79b307b-1089-4db9-9cec-e4c8a673bc4a");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f79b307b-1089-4db9-9cec-e4c8a673bc4a' but no matching script tag was found.")
        }
