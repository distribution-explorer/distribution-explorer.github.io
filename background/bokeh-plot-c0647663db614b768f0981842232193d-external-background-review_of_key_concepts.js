(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("3790ab69-e936-42a7-bd5c-c543bd009e72");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '3790ab69-e936-42a7-bd5c-c543bd009e72' but no matching script tag was found.")
        }
