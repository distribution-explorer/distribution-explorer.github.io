(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d08a1e7a-7673-485e-bc68-50320ec36aab");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd08a1e7a-7673-485e-bc68-50320ec36aab' but no matching script tag was found.")
        }
