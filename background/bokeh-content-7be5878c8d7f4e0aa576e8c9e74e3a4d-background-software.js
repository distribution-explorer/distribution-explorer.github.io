(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a837c977-b47d-4344-a181-e498a2bfb331");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a837c977-b47d-4344-a181-e498a2bfb331' but no matching script tag was found.")
        }
