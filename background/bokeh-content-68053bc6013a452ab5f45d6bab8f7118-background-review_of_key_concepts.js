(function() {
  const fn = function() {
    ...
    const element = document.getElementById("ef06ad4b-c699-4681-bc41-ed53fab27fb9");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ef06ad4b-c699-4681-bc41-ed53fab27fb9' but no matching script tag was found.")
        }
