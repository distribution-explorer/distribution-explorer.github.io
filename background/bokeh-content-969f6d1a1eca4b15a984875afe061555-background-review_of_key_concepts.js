(function() {
  const fn = function() {
    ...
    const element = document.getElementById("ec6845ec-42d1-43bb-b679-40036fbef567");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ec6845ec-42d1-43bb-b679-40036fbef567' but no matching script tag was found.")
        }
