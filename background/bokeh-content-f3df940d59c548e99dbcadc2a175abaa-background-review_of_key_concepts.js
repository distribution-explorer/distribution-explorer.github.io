(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b71eaba6-1673-4f1c-a12c-e5a868335b65");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b71eaba6-1673-4f1c-a12c-e5a868335b65' but no matching script tag was found.")
        }
