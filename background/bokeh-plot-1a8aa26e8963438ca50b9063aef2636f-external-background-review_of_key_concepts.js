(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("48b0e7d1-13c0-40b0-aea8-04eff96f28d1");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '48b0e7d1-13c0-40b0-aea8-04eff96f28d1' but no matching script tag was found.")
        }
