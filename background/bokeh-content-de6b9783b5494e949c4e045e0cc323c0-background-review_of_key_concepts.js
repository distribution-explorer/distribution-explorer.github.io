(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b5b3bc2b-0e8e-42a6-ad17-bdbd04d399d2");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b5b3bc2b-0e8e-42a6-ad17-bdbd04d399d2' but no matching script tag was found.")
        }
