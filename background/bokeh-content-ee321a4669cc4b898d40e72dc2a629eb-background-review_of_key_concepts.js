(function() {
  const fn = function() {
    ...
    const element = document.getElementById("dfde862d-0860-4186-b0e0-39209358ed43");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'dfde862d-0860-4186-b0e0-39209358ed43' but no matching script tag was found.")
        }
