(function() {
  const fn = function() {
    ...
    const element = document.getElementById("e45a8cbf-3c01-433c-b660-f4592fb36535");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e45a8cbf-3c01-433c-b660-f4592fb36535' but no matching script tag was found.")
        }
