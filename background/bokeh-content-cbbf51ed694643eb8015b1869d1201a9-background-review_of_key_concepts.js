(function() {
  const fn = function() {
    ...
    const element = document.getElementById("ecea7315-f8f4-4ba9-8fd2-ce9bd1e7b38f");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ecea7315-f8f4-4ba9-8fd2-ce9bd1e7b38f' but no matching script tag was found.")
        }
