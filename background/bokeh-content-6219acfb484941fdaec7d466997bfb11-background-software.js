(function() {
  const fn = function() {
    ...
    const element = document.getElementById("df975c95-cb65-4266-832a-ac7d54b0b6f8");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'df975c95-cb65-4266-832a-ac7d54b0b6f8' but no matching script tag was found.")
        }
