(function() {
  const fn = function() {
    ...
    const element = document.getElementById("af5457f6-d32d-4d2f-ba9b-3ef0478d2ff8");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'af5457f6-d32d-4d2f-ba9b-3ef0478d2ff8' but no matching script tag was found.")
        }
