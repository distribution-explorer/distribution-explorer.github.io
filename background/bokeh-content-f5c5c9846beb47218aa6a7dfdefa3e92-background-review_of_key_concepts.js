(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b8e86738-3bd1-4165-92c4-d16bc31f0bc4");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b8e86738-3bd1-4165-92c4-d16bc31f0bc4' but no matching script tag was found.")
        }
