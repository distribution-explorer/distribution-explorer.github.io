(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("c993713e-a0ca-4378-8bbf-007a69323904");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c993713e-a0ca-4378-8bbf-007a69323904' but no matching script tag was found.")
        }
