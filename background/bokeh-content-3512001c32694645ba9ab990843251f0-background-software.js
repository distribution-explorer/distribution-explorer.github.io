(function() {
  const fn = function() {
    ...
    const element = document.getElementById("e17cba96-78a5-46ab-9641-e8849df86215");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e17cba96-78a5-46ab-9641-e8849df86215' but no matching script tag was found.")
        }
