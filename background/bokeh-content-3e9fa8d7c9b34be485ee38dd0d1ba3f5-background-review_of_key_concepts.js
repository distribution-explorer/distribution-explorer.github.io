(function() {
  const fn = function() {
    ...
    const element = document.getElementById("f121cd64-a08c-4ffd-a842-28873e228c1b");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f121cd64-a08c-4ffd-a842-28873e228c1b' but no matching script tag was found.")
        }
