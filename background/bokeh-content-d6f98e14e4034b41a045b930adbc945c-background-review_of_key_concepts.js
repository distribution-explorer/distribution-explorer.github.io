(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b32704fc-1f22-404c-a768-e0eaf648d2fb");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b32704fc-1f22-404c-a768-e0eaf648d2fb' but no matching script tag was found.")
        }
