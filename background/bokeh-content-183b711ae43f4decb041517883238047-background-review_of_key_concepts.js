(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a74105bb-6220-4488-96cf-5015696b5a37");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a74105bb-6220-4488-96cf-5015696b5a37' but no matching script tag was found.")
        }
