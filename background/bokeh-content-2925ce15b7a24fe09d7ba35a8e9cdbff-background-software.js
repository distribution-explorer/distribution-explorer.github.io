(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bec93bf7-3d8c-43bf-a191-f98fbc8e8b4d");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bec93bf7-3d8c-43bf-a191-f98fbc8e8b4d' but no matching script tag was found.")
        }
