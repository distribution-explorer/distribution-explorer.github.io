(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("b86a03a3-e435-44fe-b731-ae645e9b6dda");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b86a03a3-e435-44fe-b731-ae645e9b6dda' but no matching script tag was found.")
        }
