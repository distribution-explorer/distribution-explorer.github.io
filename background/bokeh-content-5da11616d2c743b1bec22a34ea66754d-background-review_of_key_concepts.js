(function() {
  const fn = function() {
    ...
    const element = document.getElementById("e3952c22-2729-4924-b221-514d22518175");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e3952c22-2729-4924-b221-514d22518175' but no matching script tag was found.")
        }
