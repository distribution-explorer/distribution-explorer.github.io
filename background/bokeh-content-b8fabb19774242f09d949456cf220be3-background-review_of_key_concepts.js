(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d34d97a2-6691-4a7d-b843-4236e7002cc4");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd34d97a2-6691-4a7d-b843-4236e7002cc4' but no matching script tag was found.")
        }
