(function() {
  const fn = function() {
    ...
    const element = document.getElementById("f0a11873-24c2-459f-a8aa-57b82ae2fb5c");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f0a11873-24c2-459f-a8aa-57b82ae2fb5c' but no matching script tag was found.")
        }
