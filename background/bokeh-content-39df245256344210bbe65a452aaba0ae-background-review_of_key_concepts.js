(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a13d1018-5979-432e-b891-44b3f5bde4db");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a13d1018-5979-432e-b891-44b3f5bde4db' but no matching script tag was found.")
        }
