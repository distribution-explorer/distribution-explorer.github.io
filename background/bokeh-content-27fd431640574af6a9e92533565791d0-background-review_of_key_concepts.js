(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bed9fc1f-624c-45f1-9129-fc8d83f33a52");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bed9fc1f-624c-45f1-9129-fc8d83f33a52' but no matching script tag was found.")
        }
