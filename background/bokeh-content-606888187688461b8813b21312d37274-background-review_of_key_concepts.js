(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c0894463-6ad8-4665-bfa7-c007127bb333");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c0894463-6ad8-4665-bfa7-c007127bb333' but no matching script tag was found.")
        }
