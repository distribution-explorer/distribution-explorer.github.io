(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("b61056d5-2aef-409b-b58e-18ddc7a6452d");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b61056d5-2aef-409b-b58e-18ddc7a6452d' but no matching script tag was found.")
        }
