(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c39326a8-9072-4f13-805d-3320ed5f9598");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c39326a8-9072-4f13-805d-3320ed5f9598' but no matching script tag was found.")
        }
