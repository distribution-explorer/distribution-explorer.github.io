(function() {
  const fn = function() {
    ...
    const element = document.getElementById("f6312169-b92a-46b4-b524-604afb60c9af");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f6312169-b92a-46b4-b524-604afb60c9af' but no matching script tag was found.")
        }
