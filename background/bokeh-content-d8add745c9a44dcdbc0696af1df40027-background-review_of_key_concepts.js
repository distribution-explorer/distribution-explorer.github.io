(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b68ce51f-15b2-4858-b85e-aab0b53e89c7");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b68ce51f-15b2-4858-b85e-aab0b53e89c7' but no matching script tag was found.")
        }
