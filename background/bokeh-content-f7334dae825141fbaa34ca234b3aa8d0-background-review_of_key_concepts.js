(function() {
  const fn = function() {
    ...
    const element = document.getElementById("cb27c830-d965-4d40-9ba2-0c925a240ced");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'cb27c830-d965-4d40-9ba2-0c925a240ced' but no matching script tag was found.")
        }
