(function() {
  const fn = function() {
    ...
    const element = document.getElementById("af84b70e-d9d1-40bb-a05b-a7ccf8f297b6");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'af84b70e-d9d1-40bb-a05b-a7ccf8f297b6' but no matching script tag was found.")
        }
