(function() {
  const fn = function() {
    ...
    const element = document.getElementById("f5723f37-d899-4af8-b802-a0071c4be6be");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f5723f37-d899-4af8-b802-a0071c4be6be' but no matching script tag was found.")
        }
