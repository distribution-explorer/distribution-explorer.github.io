(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b181739b-0982-43ad-abe6-ffe4c4968aa7");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b181739b-0982-43ad-abe6-ffe4c4968aa7' but no matching script tag was found.")
        }
