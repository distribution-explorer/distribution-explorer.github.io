(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b29bf847-0668-43d1-b2df-b2dd36c31472");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b29bf847-0668-43d1-b2df-b2dd36c31472' but no matching script tag was found.")
        }
