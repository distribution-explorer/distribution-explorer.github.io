(function() {
  const fn = function() {
    ...
    const element = document.getElementById("f3591c68-cb09-4260-8aee-55d2c1ac3465");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f3591c68-cb09-4260-8aee-55d2c1ac3465' but no matching script tag was found.")
        }
