(function() {
  const fn = function() {
    ...
    const element = document.getElementById("ce0fd9ea-b663-41b5-860a-6efbb11e3e54");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ce0fd9ea-b663-41b5-860a-6efbb11e3e54' but no matching script tag was found.")
        }
