(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("8e0b497f-daa6-43c3-97e6-dc13f2f310e0");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '8e0b497f-daa6-43c3-97e6-dc13f2f310e0' but no matching script tag was found.")
        }
