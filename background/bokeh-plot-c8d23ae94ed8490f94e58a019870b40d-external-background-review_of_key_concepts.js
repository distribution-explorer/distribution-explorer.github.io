(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("99d9aae3-f7ca-4fc3-a3a5-051f2ac488df");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '99d9aae3-f7ca-4fc3-a3a5-051f2ac488df' but no matching script tag was found.")
        }
