(function() {
  const fn = function() {
    ...
    const element = document.getElementById("ff038163-09a6-4074-b67b-3cee78a7db8e");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ff038163-09a6-4074-b67b-3cee78a7db8e' but no matching script tag was found.")
        }
