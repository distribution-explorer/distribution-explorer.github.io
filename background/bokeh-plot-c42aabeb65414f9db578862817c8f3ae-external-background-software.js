(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("078310fb-f55e-4f73-87b4-21c6cf6aa99f");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '078310fb-f55e-4f73-87b4-21c6cf6aa99f' but no matching script tag was found.")
        }
