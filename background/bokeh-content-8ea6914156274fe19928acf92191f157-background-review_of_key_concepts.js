(function() {
  const fn = function() {
    ...
    const element = document.getElementById("e27e1f31-e889-469f-81ca-6c13beb8817a");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e27e1f31-e889-469f-81ca-6c13beb8817a' but no matching script tag was found.")
        }
