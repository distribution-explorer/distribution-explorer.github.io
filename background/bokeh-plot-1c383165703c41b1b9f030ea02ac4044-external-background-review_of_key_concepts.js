(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("94cecd49-e923-42d3-8387-49f9c42bb21c");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '94cecd49-e923-42d3-8387-49f9c42bb21c' but no matching script tag was found.")
        }
