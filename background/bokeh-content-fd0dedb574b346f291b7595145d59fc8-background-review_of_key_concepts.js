(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c3ec7015-fd05-4acc-92da-da22f69b182e");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c3ec7015-fd05-4acc-92da-da22f69b182e' but no matching script tag was found.")
        }
