(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("1a472f7c-d5da-4786-8e10-23c4b913f66f");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '1a472f7c-d5da-4786-8e10-23c4b913f66f' but no matching script tag was found.")
        }
