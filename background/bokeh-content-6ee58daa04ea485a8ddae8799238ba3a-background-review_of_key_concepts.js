(function() {
  const fn = function() {
    ...
    const element = document.getElementById("fe74d37f-f275-44b4-abfc-6517cade4650");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'fe74d37f-f275-44b4-abfc-6517cade4650' but no matching script tag was found.")
        }
