(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("a6e49538-e5c9-486b-97fe-c14ae51774f9");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a6e49538-e5c9-486b-97fe-c14ae51774f9' but no matching script tag was found.")
        }
