(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("09104955-ecea-487e-9f06-19604d3e08cc");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '09104955-ecea-487e-9f06-19604d3e08cc' but no matching script tag was found.")
        }
